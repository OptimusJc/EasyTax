        ...
        <div className={["col", styles.div_col_input].join(" ")}>
          <div className={[styles.input_div]}>
            <p className="fw-bold fs-4">
              <span className={[styles.dash_before_register]}></span>
              register
            </p>

            <Input title="email" classes={styles.input} type="text" />
            <Input title="kra pin" classes={styles.input} type="text" />
            <Input title="password" classes={styles.input} type="password" />
            <Input
            ...
            <div className="d-flex justify-content-center">
              <Button
                title="register"
                classes={["btn", "btn-danger", styles.btn_danger].join(" ")}
              />
            </div>
